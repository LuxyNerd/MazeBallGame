...
public class GameLevel5 implements Screen {
    ...
    private float speed = 1.2f; // Geschwindigkeit der Kugel
    ...
    public GameLevel5(final MazeBall game) {
        this.game = game;
        ...
        wallImage = new Texture(Gdx.files.internal("wall5.png"));
        ...
        //2. H
        walls[5] = new Wall(2*blockLength, 0, wallStrength, blockLength);
    ...
    public void render(float delta) {
        ...
        Gdx.gl.glClearColor(102/255f, 102/255f, 153/255f, 1); // red, green, blue and alpha component of that color, each within the range [0, 1]
    ...
    private void wonGame() {
        game.level5done = true;
        game.setScreen(new WonScreen(game, TimeUtils.timeSinceMillis(startTime), "level5"));
        dispose();
    }
}