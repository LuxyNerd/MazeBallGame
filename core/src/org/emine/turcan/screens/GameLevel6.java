...
public class GameLevel6 implements Screen {
    ...
    public GameLevel6(final MazeBall game) {
        this.game = game;
        ...
        wallImage = new Texture(Gdx.files.internal("wall6.png"));
    ...
    public void render(float delta) {
        Gdx.gl.glClearColor(183/255f, 154/255f, 154/255f, 1); // red, green, blue and alpha component of that color, each within the range [0, 1]
    ...
    private void wonGame() {
        ...
        game.setScreen(new WonScreen(game, TimeUtils.timeSinceMillis(startTime), "level6"));
        dispose();
    }
}
