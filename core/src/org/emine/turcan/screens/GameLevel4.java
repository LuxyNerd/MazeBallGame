...
public class GameLevel4 implements Screen {
    ...
    private float speed = 1.3f; // Geschwindigkeit der Kugel
    ...
    public GameLevel4(final MazeBall game) {
        this.game = game;
        ...
        wallImage = new Texture(Gdx.files.internal("wall4.png"));
    ...
    public void render(float delta) {
        Gdx.gl.glClearColor(177/255f, 177/255f, 139/255f, 1); // red, green, blue and alpha component of that color, each within the range [0, 1]
    ...
    private void wonGame() {
        game.level4done = true;
        game.setScreen(new WonScreen(game, TimeUtils.timeSinceMillis(startTime), "level4"));
        dispose();
    }
}
